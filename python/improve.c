...
#define NUM_FEATURES 9 //普通，角，中央，角の隣
double weight[NUM_FEATURES] = {100,610.2,-112.3,-194.9, 0, 0, 0, 0, 0}; // weights of the features
...
int feature(int id)
{
    ...
    switch(id){
        ...
        case 4:
            return board[0][2] + board[0][3] + board[0][4] + board[0][5] + board[2][0] + board[2][7] + board[3][0] + board[3][7]
                 + board[4][0] + board[4][7] + board[5][0] + board[5][7] + board[7][2] + board[7][3] + board[7][4] + board[7][5];

        case 5:
            return board[1][1] + board[1][6] + board[6][1] + board[6][6];

        case 6:
            return board[1][2] + board[1][3] + board[1][4] + board[1][5] + board[2][1] + board[2][6] + board[3][1] + board[3][6]
                 + board[4][1] + board[4][6] + board[5][1] + board[5][6] + board[6][2] + board[6][3] + board[6][4] + board[6][5];
